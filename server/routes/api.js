...
exports.savedata = (req, res) => {
    mongoDbHelper.collection("planets").insert(req.body)
			.then((results) => {
        res.status(201);
...
exports.getplanets = ( req, res) =>{
  mongoDbHelper.collection("planets").find()
  .then((result) => {
    res.json({
      status: 'success',
      planets: result,
...
exports.saveComment = (req, res) => {
  ...
  mongoDbHelper.collection("comments").insert(req.body)
  	.then((results) => {
      res.status(201);
      res.json({status: true})
  })
...
exports.delComment = (req, res) => {
  ...
  mongoDbHelper.collection("comments").delete(req.body.comment_id)
  	.then((results) => {
      res.status(201);
...
exports.getComments = ( req, res) =>{
  mongoDbHelper.collection("comments").find()
  .then((result) => {
    res.json({
      status: 'success',
      comments: result,
